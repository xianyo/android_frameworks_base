...
public:
    ...
    virtual	status_t		setAudioSampleRate(int samples_per_second) = 0;
    virtual	status_t		setAudioBitRate(int bits_per_second) = 0;
    virtual	status_t		setAudioChannel(int channel) = 0;
